...
var download = function (filePath, options, doneCallback) {
    ...
    var startDownload = function () {
        ...
        if (options.clean) {
            _.each(glob.sync(pathLocations.base + "/*"), fs.unlinkSync);
        }
        var copiedModFilePath = path.join(pathLocations.base, pathLocations.content);
        ...
        async.everyLimit(externalResources, numberOfConcurrentDownloads, _.curry(downloadUrl)(pathLocations.base), function () {
